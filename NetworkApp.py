...
# Calling threads creation function for one or multiple SSH connection
# NOTE: this while loop is an infinite loop that will exit only when we press ctrl+c
while True:  # we introduce this while loop to capture cpu utilization every 10 seconds
